...
function AdminPermissionPaging(props) {
    ...
    const [notFound, setNotFound] = useState('Không tìm thấy quyền nào!');
    ...
    useEffect(() => {
        ...
        if (dataValue.listQ && dataValue.listQ.length > 0) {
...
export default React.memo(AdminPermissionPaging)
